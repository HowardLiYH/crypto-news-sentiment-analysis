'''
Referenced from customized bert modl on Huggingface: https://huggingface.co/ElKulako/cryptobert
'''
...
def cryptobert_pred(post):
    '''
    Input:
        post: a string of text
    Output:
        pred: a string of prediction
    '''
    model_name = "ElKulako/cryptobert"
    tokenizer = AutoTokenizer.from_pretrained(model_name, use_fast=True)
    model = AutoModelForSequenceClassification.from_pretrained(model_name, num_labels = 3)
