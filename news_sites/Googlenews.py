'''
News Title Abstraction for Googlenews
...
def get_news_titles():
    ...
    '''
    url = 'https://news.google.com/search?q=Cryptocurrency&hl=en-US&gl=US&ceid=US:en'
    name = 'Googlenews'
    ...
    # News Explorer
    explorer_titles = soup.find_all('h3', class_='ipQwMb ekueJc RD0gLb')
