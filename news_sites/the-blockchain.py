'''
News Title Abstraction for The-blockchain.com
...
def get_news_titles():
    ...
    name = 'The-blockchain.com'
    soup = connection(url, name)

    news_collector = []

    # News Explorer
    explorer_titles = soup.find_all('h3', class_='entry-title')
    ...
    news_collector = list(set(news_collector))
